public class ChatBot {
    ...
    //This will tell us debbie's favorite animal, and the user's favorite animal
    public void favoriteAnimal(String animal){
        System.out.println("My favorite animal is the dog! Your favorite animal is the " + animal + "!");
    }

    //This will tell us the sum of debbie's age and the user's age
    public int sumAges(int age){
        int debbieAge = 5;
        int sum = debbieAge + age;
        return sum;
    }
}
